...
def favorite_color(favorite_list)
  ...
  if favorite_list.values.class == Hash
    return favorite_list.keys
  elsif favorite_list.keys.include?(:number) == false || favorite_list.keys.include?(:color) == false
    return nil
  else
    return favorite_list.values.first
  end
end
...
def favorite_categories(favorite_list)
  ...
  return favorite_list.keys.flatten
end
